						...
						<div className="p-6 border-b border-neutral-200 dark:border-neutral-800">
							<DialogHeader>
								...
								<DialogDescription className="text-neutral-600 dark:text-neutral-400">
									Scira is an AI search engine and is not associated with any
									cryptocurrency, memecoin, or token activities. Beware of
									impersonators.
								</DialogDescription>
							</DialogHeader>
						</div>
					...
					<div className="relative pt-20 pb-20 px-4">
						...
						>
							...
							<motion.div variants={item} className="text-center">
								<Link
									href="/"
									className="inline-flex items-end gap-3 text-5xl font-syne font-bold"
								>
									<NextImage
										src="/scira.png"
										alt="Scira Logo"
							...
							<motion.div variants={item} className="text-center space-y-6">
								<p className="text-xl text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
									A minimalistic AI-powered search engine with RAG and search
									grounding capabilities. Open source and built for everyone.
								</p>
							</motion.div>
							...
							>
								...
								>
									...
									>
										<path
											d="M6.66667 12.6667L11.3333 8.00004L6.66667 3.33337"
											stroke="currentColor"
											strokeWidth="2"
											strokeLinecap="round"
					...
					>
						<div className="text-center space-y-4 mb-16">
							...
							<p className="text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
								Watch how Scira combines RAG and search grounding to deliver
								...
								<div className="flex-1 space-y-4">
									...
									<div className="space-y-2">
										...
										<TextShimmer className="text-sm font-medium">
											Combining insights from multiple sources for a
								...
								<div className="flex-1 space-y-2">
									...
									<div className="prose prose-sm dark:prose-invert">
										<p className="text-neutral-900 dark:text-neutral-100">
											...
											harnesses quantum mechanics to solve complex problems...
										</p>
										<div className="text-xs text-neutral-500 mt-2">
											Sources: Nature Physics, IBM Research, MIT Technology
											Review
										</div>
									</div>
								</div>
				...
				<div className="py-24 px-4">
					...
					>
						<div className="text-center space-y-4">
							...
							<p className="text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
								Each model is carefully selected for its unique strengths in
				...
				<div className="py-20 px-4 bg-white dark:bg-black border-y border-neutral-200 dark:border-neutral-800">
					...
					>
						<div className="text-center space-y-3">
							...
							<p className="text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
								Join the growing community of developers and researchers using
								Scira.
							</p>
						</div>
				...
				<div className="py-24 px-4">
					...
					>
						<div className="text-center space-y-4">
							...
							<p className="text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
								Experience a smarter way to search with AI-powered features that
				...
				<div className="py-24 px-4 bg-neutral-50 dark:bg-neutral-900/50 border-y border-neutral-200 dark:border-neutral-800">
					<motion.div className="container max-w-5xl mx-auto space-y-16">
						<div className="text-center space-y-4">
							...
							<p className="text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
								Whether you need quick answers or in-depth research, Scira
								adapts to your search needs.
							</p>
						</div>
					...
					<div className="mx-auto max-w-5xl px-4 py-12">
						<div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
							<div className="flex items-center gap-3">
								...
								<p className="text-sm text-neutral-600 dark:text-neutral-400">
									© <Var>{new Date().getFullYear()}</Var> All rights reserved.
								</p>
							</div>
